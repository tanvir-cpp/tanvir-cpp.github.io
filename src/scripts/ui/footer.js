import { SOCIAL, META } from "../constants.js";
          ...
          <div class="lg:col-span-6 space-y-6">
            <div class="space-y-4">
              ...
              <p class="text-lg md:text-xl font-light text-primary/90 leading-snug tracking-tight max-w-md">
                CSE student at AIUB, interested in <span class="italic text-accent-indigo font-serif">web development</span>, databases & AI.
              </p>
            </div>
            ...
            <div class="flex flex-col space-y-4">
               ...
               <a href=\"mailto:${SOCIAL.EMAIL}\" class=\"text-[9px] font-black uppercase tracking-[0.4em] text-accent-indigo hover:text-primary transition-colors py-1 group w-fit\">
          ...
          <div class="lg:col-span-6 grid grid-cols-3 gap-6 lg:gap-8">
            <div class="space-y-4">
              ...
              <ul class="flex flex-col gap-3 text-[11px] font-bold uppercase tracking-[0.15em] text-secondary/80">
                ...
                <li><a href="research.html" class="hover:text-primary transition-all">Research</a></li>
              </ul>
            </div>
            ...
            <div class="space-y-4">
              ...
              <ul class="flex flex-col gap-3 text-[11px] font-bold uppercase tracking-[0.15em] text-secondary/80">
                <li>
                  <a href="${SOCIAL.GITHUB}" class="group flex items-center gap-2 hover:text-primary transition-all">
                    <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></svg>
                    <span>GitHub</span>
                  </a>
                </li>
                <li>
                  <a href="${SOCIAL.TWITTER}" class="group flex items-center gap-2 hover:text-primary transition-all">
                ...
                <li>
                  <a href="${SOCIAL.LINKEDIN}" class="group flex items-center gap-2 hover:text-primary transition-all">
